/*****************************************************************************
* Filename:          C:\Users\marti\OneDrive\Documentos\4\proyectFinal\SE/drivers/motor_v1_00_a/src/motor_selftest.c
* Version:           1.00.a
...
XStatus MOTOR_SelfTest(void * baseaddr_p)
{
  ...
  MOTOR_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = MOTOR_mReadSlaveReg1(baseaddr, 0);
