...
--motor_ctl (0) <= '0'; -- dir
  ...
  signal internal_dir, internal_stop, internal_halfstep : std_logic;
	...
	end component one_hundred_K_counter;
...
divisor_frec: one_hundred_K_counter 
  ...
  slv_write_ack     <= Bus2IP_WrCE(0) or Bus2IP_WrCE(C_NUM_REG - 1);
  slv_read_ack      <= Bus2IP_RdCE(0) or Bus2IP_RdCE(C_NUM_REG - 1);
