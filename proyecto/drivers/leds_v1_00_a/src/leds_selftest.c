/*****************************************************************************
* Filename:          C:\Users\CJRipa\Desktop\SE-main\proyecto/drivers/leds_v1_00_a/src/leds_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the leds driver
...
XStatus LEDS_SelfTest(void * baseaddr_p)
{
  ...
  LEDS_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = LEDS_mReadSlaveReg0(baseaddr, 0);
  ...
  LEDS_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = LEDS_mReadSlaveReg1(baseaddr, 0);
  ...
  LEDS_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = LEDS_mReadSlaveReg2(baseaddr, 0);
