/*****************************************************************************
* Filename:          U:\hlocal\git\SE\extraordinaria\proyecto/drivers/lcd_v1_00_a/src/lcd.h
* Version:           1.00.a
...
#define LCD_SLV_REG0_OFFSET (LCD_USER_SLV_SPACE_OFFSET + 0x00000000)
...
/**
 *
 * Write/Read 32 bit value to/from LCD user logic slave registers.
 *
 * @param   BaseAddress is the base address of the LCD device.
 ...
 * @note
 * C-style signature:
 * 	void LCD_mWriteSlaveRegn(Xuint32 BaseAddress, unsigned RegOffset, Xuint32 Value)
 * 	Xuint32 LCD_mReadSlaveRegn(Xuint32 BaseAddress, unsigned RegOffset)
 *
 */
#define LCD_mWriteSlaveReg0(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (LCD_SLV_REG0_OFFSET) + (RegOffset), (Xuint32)(Value))

#define LCD_mReadSlaveReg0(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (LCD_SLV_REG0_OFFSET) + (RegOffset))
