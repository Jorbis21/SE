...
//Periféricos usados en el proyecto
#include "keypad.h"
#include "lcd.h"
#include "leds.h"
...
void practica5(){
	...
	//EL LED SE USARÁ PARA REPRESENTAR EL COLOR DEL AUTOBUS:
	//	- SI ES UNA LINEA QUE VA DE UN PUNTO A OTRO PUNTO DE MADRID ES PONDRÁ AZUL
