/*****************************************************************************
* Filename:          U:\hlocal\git\SE\extraordinaria\proyecto/drivers/lcd_v1_00_a/src/lcd_selftest.c
* Version:           1.00.a
...
XStatus LCD_SelfTest(void * baseaddr_p)
{
  ...
  LCD_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = LCD_mReadSlaveReg0(baseaddr, 0);
