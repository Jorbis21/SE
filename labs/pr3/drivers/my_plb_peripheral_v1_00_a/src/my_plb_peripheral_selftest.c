/*****************************************************************************
* Filename:          U:\hlocal\PABLO\SE\labs\pr3/drivers/my_plb_peripheral_v1_00_a/src/my_plb_peripheral_selftest.c
* Version:           1.00.a
...
XStatus MY_PLB_PERIPHERAL_SelfTest(void * baseaddr_p)
{
  ...
  MY_PLB_PERIPHERAL_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = MY_PLB_PERIPHERAL_mReadSlaveReg1(baseaddr, 0);
  ...
  MY_PLB_PERIPHERAL_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = MY_PLB_PERIPHERAL_mReadSlaveReg2(baseaddr, 0);
  ...
  MY_PLB_PERIPHERAL_mWriteSlaveReg3(baseaddr, 0, 4);
  Reg32Value = MY_PLB_PERIPHERAL_mReadSlaveReg3(baseaddr, 0);
