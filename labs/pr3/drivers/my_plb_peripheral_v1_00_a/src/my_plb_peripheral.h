/*****************************************************************************
* Filename:          U:\hlocal\PABLO\SE\labs\pr3/drivers/my_plb_peripheral_v1_00_a/src/my_plb_peripheral.h
* Version:           1.00.a
...
#define MY_PLB_PERIPHERAL_SLV_REG1_OFFSET (MY_PLB_PERIPHERAL_USER_SLV_SPACE_OFFSET + 0x00000004)
#define MY_PLB_PERIPHERAL_SLV_REG2_OFFSET (MY_PLB_PERIPHERAL_USER_SLV_SPACE_OFFSET + 0x00000008)
#define MY_PLB_PERIPHERAL_SLV_REG3_OFFSET (MY_PLB_PERIPHERAL_USER_SLV_SPACE_OFFSET + 0x0000000C)
...
#define MY_PLB_PERIPHERAL_mWriteSlaveReg1(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (MY_PLB_PERIPHERAL_SLV_REG1_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_PLB_PERIPHERAL_mWriteSlaveReg2(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (MY_PLB_PERIPHERAL_SLV_REG2_OFFSET) + (RegOffset), (Xuint32)(Value))
#define MY_PLB_PERIPHERAL_mWriteSlaveReg3(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (MY_PLB_PERIPHERAL_SLV_REG3_OFFSET) + (RegOffset), (Xuint32)(Value))
...
#define MY_PLB_PERIPHERAL_mReadSlaveReg1(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (MY_PLB_PERIPHERAL_SLV_REG1_OFFSET) + (RegOffset))
#define MY_PLB_PERIPHERAL_mReadSlaveReg2(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (MY_PLB_PERIPHERAL_SLV_REG2_OFFSET) + (RegOffset))
#define MY_PLB_PERIPHERAL_mReadSlaveReg3(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (MY_PLB_PERIPHERAL_SLV_REG3_OFFSET) + (RegOffset))
